    ...
    <div class="bs-docs-section">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" action="/posts/add" method="post">
                    @csrf
                    <div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input class="form-control" id="input" value=" {{old('title')}}" placeholder="Title" type="text" name ="title">
                        </div>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                                <textarea class="form-control" rows="3" placeholder="Content" id="textArea" name ="body">{{old('body')}}</textarea>
